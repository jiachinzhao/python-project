    ...
    def study(self, link):
        ...
        for link in link_list:
            try:
                ...
                print(msg)   
        '''
        #link = 'http://hnust.hunbys.com/index.php/course/Index/detail/kcid/57de44d9dfec2431775443_736/zid/57de4574cafa1521690739_736/jid/57de4fd2aa4d0985052431_736.html'
        while True:
            try:
...
if __name__ == '__main__':
    ...
    process.login()
    process.study('http://hnust.hunbys.com/index.php/course/Index/detail/kcid/57de44d9dfec2431775443_736/zid/57de4574cafa1521690739_736/jid/57de4fd2aa4d0985052431_736.html')